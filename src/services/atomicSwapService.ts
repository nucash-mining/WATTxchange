  ...
  async createEVMSwap(
    ...
    try {
      ...
      const swapId = await this.atomicSwapContract.generateSwapId(
        await this.atomicSwapContract.signer.getAddress(),
        tokenAddress,
      ...
      if (tokenAddress === ethers.ZeroAddress) {
        ...
        const tokenContract = new ethers.Contract(
          ...
          this.atomicSwapContract.signer
        );
  ...
  async createUTXOSwap(
    ...
    try {
      ...
      const swapId = await this.utxoHelperContract.generateUTXOSwapId(
        await this.utxoHelperContract.signer.getAddress(),
        chainEnum,
        utxoAddress,
      ...
      return {
        id: swapId,
        maker: await this.utxoHelperContract.signer.getAddress(),
        taker: null,
        sendChain: utxoChain,
