...
const AtomicSwapForm: React.FC = () => {
  ...
  const evmChains = ['ETH', 'ALT', 'WATT'];
  const utxoChains = ['BTC', 'LTC', 'XMR', 'GHOST', 'TROLL', 'HTH'];
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    {receiveChain === 'BTC' ? 'Bitcoin' :
                     ...
                     receiveChain === 'HTH' ? 'Help The Homeless' : receiveChain}
                  </p>
                </div>
              </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {receiveChain === 'BTC' ? '2 confirmations' :
                     ...
                     receiveChain === 'HTH' ? '6 confirmations' : '1 confirmation'}
                  </span>
                </div>
                <div className="flex justify-between">
                  ...
                  <span>
                    {receiveChain === 'BTC' ? '~20 minutes' :
                     ...
                     receiveChain === 'HTH' ? '~10 minutes' : '~5 minutes'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-400">Network Fee:</span>
                  <span>
                    {receiveChain === 'BTC' ? '~0.0001 BTC' :
                     ...
                     receiveChain === 'HTH' ? '~0.01 HTH' : '~0.001'}
                  </span>
                </div>
              </div>
